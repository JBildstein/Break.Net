...
{
    /// <summary>
    /// Removed field readonly keyword change
    /// </summary>
    public class FieldReadonlyRemoveChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "FIE003";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="FieldReadonlyRemoveChange"/> class
        /// </summary>
        /// <param name="parent">The type that contains the field</param>
        /// <param name="field">The changed field</param>
        public FieldReadonlyRemoveChange(TypeInfo parent, FieldInfo field)
        {
        ...
        {
            return $"Field {Field.Name} of type {Parent.FullName} not readonly anymore";
        }
    }
}
