...
{
    /// <summary>
    /// Added field constant keyword change
    /// </summary>
    public class FieldConstantAddChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "FIE005";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="FieldConstantAddChange"/> class
        /// </summary>
        /// <param name="parent">The type that contains the field</param>
        /// <param name="field">The changed field</param>
        public FieldConstantAddChange(TypeInfo parent, FieldInfo field)
        {
        ...
        {
            return $"Field {Field.Name} of type {Parent.FullName} made constant";
        }
    }
}
