...
{
    /// <summary>
    /// Constructor parameter name change
    /// </summary>
    public class ConstructorParameterNameChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "CTR001";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ConstructorParameterNameChange"/> class
        /// </summary>
        ...
        public ConstructorParameterNameChange(TypeInfo parent, ConstructorInfo constructor, ParameterInfo oldParameter, ParameterInfo newParameter)
        {
        ...
        {
            return $"Name of parameter of constructor of type {Parent.FullName} changed" +
                $" from {OldParameter.Name} to {NewParameter.Name}";
        }
    }
}
