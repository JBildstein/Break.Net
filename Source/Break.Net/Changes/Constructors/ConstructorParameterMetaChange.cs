...
{
    /// <summary>
    /// Constructor parameter meta change
    /// </summary>
    public class ConstructorParameterMetaChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "CTR002";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ConstructorParameterMetaChange"/> class
        /// </summary>
        ...
        public ConstructorParameterMetaChange(TypeInfo parent, ConstructorInfo constructor, ParameterInfo oldParameter, ParameterInfo newParameter)
        {
        ...
        {
            return $"Metadata of parameter {NewParameter.Name} of constructor of type {Parent.FullName} changed";
        }
    }
}
