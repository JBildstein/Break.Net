...
{
    /// <summary>
    /// Constructor parameter default value change
    /// </summary>
    public class ConstructorParameterDefaultValueChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "CTR005";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ConstructorParameterDefaultValueChange"/> class
        /// </summary>
        ...
        public ConstructorParameterDefaultValueChange(TypeInfo parent, ConstructorInfo constructor, ParameterInfo oldParameter, ParameterInfo newParameter)
        {
        ...
        {
            return $"Default value of parameter {NewParameter.Name} of constructor of type {Parent.FullName} changed";
        }
    }
}
