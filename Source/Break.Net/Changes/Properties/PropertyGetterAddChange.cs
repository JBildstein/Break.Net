...
{
    /// <summary>
    /// Added getter for property change
    /// </summary>
    public class PropertyGetterAddChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "PRO006";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="PropertyGetterAddChange"/> class
        /// </summary>
        /// <param name="parent">The type that contains the property</param>
        /// <param name="property">The changed property</param>
        public PropertyGetterAddChange(TypeInfo parent, PropertyInfo property)
        {
        ...
        {
            return $"New getter for property {Property.Name} of type {Parent.FullName} added";
        }
    }
}
