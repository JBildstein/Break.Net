...
{
    /// <summary>
    /// Method parameter name change
    /// </summary>
    public class MethodParameterNameChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "MET004";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="MethodParameterNameChange"/> class
        /// </summary>
        ...
        public MethodParameterNameChange(TypeInfo parent, MethodInfo method, ParameterInfo oldParameter, ParameterInfo newParameter)
        {
        ...
        {
            return $"Name of parameter of method {Method.Name} of type {Parent.FullName} changed" +
