...
{
    /// <summary>
    /// Method parameter default value change
    /// </summary>
    public class MethodParameterDefaultValueChange : IChange
    {
        /// <summary>
        /// Change ID
        /// </summary>
        public const string IdConstant = "MET006";
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="MethodParameterDefaultValueChange"/> class
        /// </summary>
        ...
        public MethodParameterDefaultValueChange(TypeInfo parent, MethodInfo method, ParameterInfo oldParameter, ParameterInfo newParameter)
        {
        ...
        {
            return $"Default value of parameter {NewParameter.Name} of method {Method.Name} of type {Parent.FullName} changed";
        }
    }
}
